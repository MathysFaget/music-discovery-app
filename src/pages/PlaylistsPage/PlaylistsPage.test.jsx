...
// Expected count text after loading (matches new UI: "X of Y Playlist(s)")
const expectedCountText = `${playlistsData.items.length} of ${playlistsData.total} ${playlistsData.total === 1 ? 'Playlist' : 'Playlists'}`;
...
describe('PlaylistsPage', () => {
    ...
    // should render heading of level 2 showing total playlist count (X of Y)
